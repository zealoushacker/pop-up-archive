...
.controller('DashboardCtrl', [ '$scope', 'Item', 'Loader', 'Me', '$timeout', function ItemsCtrl($scope, Item, Loader, Me, $timeout) {
  Me.authenticated(function (data) {
    ...
    $scope.slides = [
      {image: 'about/giphy2.gif', description: 'Image 00', headline: 'The web is getting noisier', text: 'Our simple tools are helping journalists, oral history collections, and media organizations around the world.', video: null, teaser: 'Pop Up Archive organizes sound so it can be found and reused.'},
