...
.controller('DashboardCtrl', [ '$scope', 'Item', 'Loader', 'Me', '$timeout', function ItemsCtrl($scope, Item, Loader, Me, $timeout) {
  Me.authenticated(function (data) {
    ...
    $scope.slides = [
      ...
      {image: 'about/binders.jpg', description: 'Image 01', headline: 'We are Pop Up Archive', text: null, video: '//player.vimeo.com/video/74795063?api=1', teaser: null},
     ...
     {image: 'about/video.jpg', description: 'Image 04', headline: 'Find lost audio', text: 'Easily indexed and organized sound means quicker workflows and new access to source material. Explore your sounds and the public repository by keyword, date, contributor, location, and more. Trapped voices and stories are waiting to be discovered.', teaser: 'Rediscover material.'},
     {image: 'about/digitalwaves.jpg', description: 'Image 05', headline: 'Add value to sound', text: 'We’re paying close attention to the lifecycle of audio on the web. Pop Up Archive\'s simple tools add value to sound by enabling new creative opportunities and wider distribution. We’re sharing our learning through blog posts, webinars, open source software contributions and a free public plan.', teaser: 'A new frontier of digital audio.'},
     {image: 'about/internet_archive.jpg', description: 'Image 06', headline: 'Integrate with workflows', text: 'We’ve done the heavy lifting and tethered lots of services in one place: transcription, cataloging, storage, preservation, a hypermedia API, and a platform for processing huge backlogs of digital sound. Rigorous user testing is at the heart of our design process. Pop Up Archive\'s partners include radio stations and producers, oral history archives, universities, and media distributors.', teaser: 'Actually simple.'}
    ]; 
