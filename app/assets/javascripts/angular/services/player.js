      ...
      template: '<div class="file-transcript">' +
                  '<table class="table">' +
                    '<tr ng-repeat="text in transcript" ng-class="{current: transcriptStart==text.startTime}" >' +
                      ...
                      '<td ng-show="editorEnabled"><input ng-model="editableTranscript" ng-enter="updateText(text)" ng-up-arrow="enableEditorPreviousField(text)" ng-show="editorEnabled" ></td>' +
